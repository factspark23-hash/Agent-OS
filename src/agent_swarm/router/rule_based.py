...
CATEGORY_AGENTS = {
    QueryCategory.NEEDS_WEB: {
        ...
        "scraping": ["data_extractor", "deep_researcher"],
        "forms": ["form_filler", "generalist"],
        "default": ["generalist", "deep_researcher"],
    },
    QueryCategory.NEEDS_SECURITY: {
        "captcha": ["captcha_solver", "security_agent"],
        "cloudflare": ["cloudflare_bypasser", "security_agent"],
        "stealth": ["stealth_agent", "security_agent"],
        "forms": ["form_filler", "security_agent"],
        "default": ["security_agent", "generalist"],
    },
